...
public final class ImageFrame {
    ...
    public ImageFrame(String filePath) throws IOException {
        this(ImageIO.read(new File(filePath)), "Image");
    }

    public ImageFrame(String filePath, String title) throws IOException {
        this(ImageIO.read(new File(filePath)), title);
    }
    ...
    public static void main(String[] args) throws IOException {
        new ImageFrame("./src/main/resources/014_1_1.bmp");
    }

    private class ScalablePane extends JPanel {
